...
function main() {
  var SCRIPT = {
      ...
      LANG = {
        errDoc: { en: 'Error\nOpen a document and try again',
                  ...
                  zh: '错误，请打开一个文档再试一次' },
        method: { en: 'Search method',
                  ru: 'Метод поиска',
                  zh: '搜索方法'},
        byName: { en: 'By name',
                  ru: 'По имени',
                  zh: '按名称'},
        byWidth: { en: 'By width, ' + CFG.units,
                   ru: 'По ширине, ' + CFG.units,
                   zh: '按宽度, ' + CFG.units},
        byHeight: { en: 'By height, ' + CFG.units,
                    ru: 'По высоте, ' + CFG.units,
                    zh: '按宽度, ' + CFG.units},
        landscape: { en: 'Landscape',
                     ru: 'Альбомные',
                     zh: 'Landscape'},
        portrait: { en: 'Portrait',
                    ru: 'Портретные',
                    zh: 'Portrait',},
        square: { en: 'Square',
                  ru: 'Квадратные',
        ...
        isZoom: { en: 'Center view with zoom ratio (' + CFG.minZoom + '-1)',
                  ...
                  zh: '具有缩放比例的中心视图 (' + CFG.minZoom + '-1)',},
        idx: { en: '#', ru: '№'},
        ab: { en: 'Name', ru: 'Имя', zh: '名称'},
        width: { en: 'Width', ru: 'Ширина', zh: '宽度'},
        height: { en: 'Height', ru: 'Высота', zh: '高度'},
  ...
  var copyright = dialog.add('statictext', undefined, '\u00A9 Sergey Osokin. 汉化: Hwangzhun | Visit Github');
      copyright.justify = 'center';

  var notice = dialog.add('statictext', undefined,'此界面为社区汉化版，功能与原版一致\n问题反馈请至汉化仓库');
