...
function main() {
  ...
  var saveRb = actionGrp.add('radiobutton', undefined, '保存到文件');
      saveRb.value = true;
  if (CFG.isMac || CFG.aiVers >= 26.4 || CFG.aiVers <= 17) {
    saveRb.active = true;
  }

  var applyRb = actionGrp.add('radiobutton', undefined, '从文件应用');

  var idxPnl = win.add('panel', undefined, '索引如面板所示');
  ...
  var startLbl = startGrp.add('statictext', undefined, '起始:');
  ...
  var endLbl = endGrp.add('statictext', undefined, '结束:');
      endLbl.justify = 'left';
  ...
  cancel.helpTip = '按 Esc 键关闭';
  ok.helpTip = '按 Esc 键关闭';

  var copyright = win.add('statictext', undefined, '\u00A9 Sergey Osokin. 汉化: Hwangzhun | Visit Github');
  copyright.justify = 'center';

  var notice = win.add('statictext', undefined,'此界面为社区汉化版，功能与原版一致\n问题反馈请至汉化仓库');
  notice.justify = 'center';
  notice.graphics.font = 'Tahoma:9';
